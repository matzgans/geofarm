...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicons -->
        <link href="{{asset('assetsDashboard')}}/img/favicon.png" rel="icon">
        <link
            href="{{asset('assetsDashboard')}}/img/apple-touch-icon.png"
        ...
        <!-- Vendor CSS Files -->
        <link
            href="{{asset('assetsDashboard')}}/vendor/bootstrap/css/bootstrap.min.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/bootstrap-icons/bootstrap-icons.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/boxicons/css/boxicons.min.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/quill/quill.snow.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/quill/quill.bubble.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/remixicon/remixicon.css"
            rel="stylesheet">
        <link
            href="{{asset('assetsDashboard')}}/vendor/simple-datatables/style.css"
            rel="stylesheet">
    ...
    <body>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <a href="index.html" class="logo d-flex align-items-center">
                    <img src="{{asset('assetsDashboard')}}/img/logo.png" alt="">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assetsDashboard')}}/img/messages-1.jpg"
                                        alt=""
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assetsDashboard')}}/img/messages-2.jpg"
                                        alt=""
                                        class="rounded-circle">
                                    <div>
                                        <h4>Anna Nelson</h4>
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assetsDashboard')}}/img/messages-3.jpg"
                                        alt=""
                                        class="rounded-circle">
                                    <div>
                                        <h4>David Muldon</h4>
        ...
        <script
            src="{{asset('assetsDashboard')}}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
        ...
        <script
            src="{{asset('assetsDashboard')}}/vendor/simple-datatables/simple-datatables.js"></script>
