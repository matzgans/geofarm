    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="{{ asset('logo') }}/logo-header.png" alt="">
                <span class="d-none d-lg-block">Geo <span class="text-warning">Farm</span></span>
            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assetsDashboard') }}/img/messages-1.jpg" alt=""
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assetsDashboard') }}/img/messages-2.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assetsDashboard') }}/img/messages-3.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                href="@if (auth()->user()->role == 'pegawai') @elseif (auth()->user()->role == 'petani')
